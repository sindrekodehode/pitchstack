...
const faqData = [
    ...
    {id: 5, question: "TBD?", answer: "Stuff & Things"},
];
        ...
        <div className={styles.container}>
            {faqData.map(({ id, question, answer }) => (
                <div key={id} onClick={() => toggleItem(id)} className={styles.list}>
                    <div className={styles.qdiv}><h2>{question}</h2><img src='/darrow.svg' alt='thick arrow pointing down' className={styles.darrow}></img></div>
