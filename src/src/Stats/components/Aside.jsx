...
export function Aside() {
    ...
    const handleCheckBoxChange =  async (fileHash, isChecked, fileName) => {
        ...
        try {
            const response = await axios.get(`https://2012-20-223-156-203.ngrok-free.app/uploads/${fileHash}`, config);
    ...
    useEffect(() => {
        ...
        axios.get("https://2012-20-223-156-203.ngrok-free.app/uploads", config)
        .then(response => {
