...
export function Header() {
  ...
  const handleSubmit = async (e, action) => {
    ...
    if (action === 'login') {
      try {
        const response =  await axios.post('https://c7db-20-223-156-203.ngrok-free.app/auth', JSON.stringify(userData), config);
      ...
      try {
        const response =  await axios.post('https://c7db-20-223-156-203.ngrok-free.app/register', JSON.stringify(userData), config);
      } catch (error) {
  ...
  const handleLogout = async (e, action) => {
    ...
    try {
      const response =  await axios.post('https://c7db-20-223-156-203.ngrok-free.app/logout', JSON.stringify(userData), config);
